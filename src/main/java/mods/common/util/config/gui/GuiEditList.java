package mods.common.util.config.gui;
...
public class GuiEditList extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(btnDefault = new GuiButtonExt(2001, this.width / 2 - buttonWidthHalf + doneWidth + 5 + undoWidth + 5, this.height - 29, resetWidth, 20, "â˜„ " + I18n.format("bspkrs.configgui.tooltip.resetToDefault")));
        this.buttonList.add(btnUndoChanges = new GuiButtonExt(2002, this.width / 2 - buttonWidthHalf + doneWidth + 5, this.height - 29, undoWidth, 20, "â†© " + I18n.format("bspkrs.configgui.tooltip.undoChanges")));
    }
